    ...
    return (
        <div>
            ...
            <div className={"projects"} id={"hover-instrs"}>
                Hover over an image to see more details.<br/>
                <a href={"https://github.com/ash13y16"}>Click here to view my github.</a>
            </div>

            <div className={"projects"}>
                <div className={"image-container"}>

                    <a href={"https://minnowdesigns.com/"}>
                        ...
                        <div className={"imageText"}>
                            ...
                            <p>
                                ...
                                ensure the website was easy to navigate and matched the company's branding. <b>Click here to check it out.</b>
                            </p>
                        </div>
                    </a>
                </div>
                ...
                <div className={"image-container"}>
                        ...
                        <a href={"https://williamsandwilliamspc.com/"}>
                            ...
                            <div className={"imageText"}>
                                ...
                                <p>
                                    ...
                                    Williams & Williams P.C. <b>Click here to check it out.</b>
                                </p>
                            </div>
                        </a>
                    </div>
                    ...
                    <div className={"image-container"}>
                        ...
                        <div className={"imageText"}>
                            ...
                            <p>
                                This is a website that I designed and built
                                using HTML, CSS, JavaScript, and React. It displays a fictional small business that
                                sells different
